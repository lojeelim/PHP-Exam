    ...
    <div class="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between flex-wrap">
        ...
        <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
            <a href="/employee/create" class="font-semibold flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-indigo-600 bg-white hover:bg-indigo-50">
          ...
          <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
              <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <form action="{{route('search-employee')}}" method="POST" enctype="multipart/form-data">
                    @method('GET')
                    @csrf
                    <div class="p-8">
              ...
              @if(count($employee) > 0)
                ...
                @foreach($employee as $index => $data)
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class=" whitespace-nowrap text-center text-sm font-medium">
                      <form action="{{route('employee.edit', $data->id)}}" method="POST" enctype="multipart/form-data">
                          @method('GET')
                          @csrf
                    ...
                    <td class="whitespace-nowrap text-center text-sm font-medium">
                      <form action="{{route('employee.show', $data->id)}}" method="POST" enctype="multipart/form-data">
                      @method('GET')
                      @csrf
                ...
                @else
                  ...
                  <div class="flex justify-center ">
                      <p class="text-3xl ... text-indigo-600">No Data</p>
                  </div>
                @endif
